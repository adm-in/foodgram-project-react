...
class TestIngredients:
    ...
    def test_ingredient_list(self, ingredients_list):
        ...
        assert (
            ingredient_1['id'] == 1
        ), 'Проверьте, что id ингредиента созадется правильно'

        assert (
            ingredient_1['name'] == 'сок'
        ), 'Проверьте, что имя ингредиента созадется правильно'
        assert (
            ingredient_1['measurement_unit'] == 'л'
        ), 'Проверьте, что единица измерения ингредиента созадется правильно'
